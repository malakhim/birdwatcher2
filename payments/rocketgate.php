...
// Billing address
$pp_data[] = 'x_first_name=' . $order_info['b_firstname'];
...
$pp_data[] = 'x_cust_id=' . $_SESSION['auth']['user_id'];
$pp_data[] = 'x_customer_ip=' . $_SERVER['REMOTE_ADDR'];
$pp_data[] = 'x_email=' . $order_info['email'];

// Merchant information
$pp_data[] = 'x_invoice_num=' . $processor_data['params']['order_prefix'] . (($order_info['repaid']) ? ($order_id . '_' . $order_info['repaid']) : $order_id);
...
$payment_url = ($processor_data['params']['mode'] == 'test') ? 'https://dev-secure.rocketgate.com/hostedpage/servlet/AuthNetEmulator' : 'https://secure.rocketgate.com/hostedpage/servlet/AuthNetEmulator';
