...
$post['cancel'] = Registry::get('config.current_location') . "/" . INDEX_SCRIPT . "?dispatch=payment_notification.cancel&payment=ideal_basic&order_id=" . $order_id;
...
$msg = str_replace('[processor]', 'iDEAL', $msg);
