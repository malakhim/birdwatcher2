<?php /* Smarty version 2.6.18, created on 2013-09-21 19:46:46
         compiled from views/checkout/components/steps/step_three.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'hook', 'views/checkout/components/steps/step_three.tpl', 21, false),array('modifier', 'replace', 'views/checkout/components/steps/step_three.tpl', 48, false),array('modifier', 'fn_url', 'views/checkout/components/steps/step_three.tpl', 48, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('change','delete','shipping_options','text_no_shipping_methods','type_comments_here','delivery_times_text','shipping_tips','delete'));
?>
<?php 
  ...
  'buttons/button.tpl' => 1372320684,
			 ...
			 ?><div class="step-container<?php if ($this->_tpl_vars['edit']): ?>-active<?php endif; ?>" id="step_three">
	<?php if ($this->_tpl_vars['settings']['General']['checkout_style'] != 'multi_page'): ?>
		<h2 class="step-title<?php if ($this->_tpl_vars['edit']): ?>-active<?php endif; ?><?php if ($this->_tpl_vars['complete'] && ! $this->_tpl_vars['edit']): ?>-complete<?php endif; ?> clearfix">
			<span class="float-left"><?php if (! $this->_tpl_vars['complete'] || $this->_tpl_vars['edit']): ?><?php if ($this->_tpl_vars['profile_fields']['B'] || $this->_tpl_vars['profile_fields']['S']): ?>3<?php else: ?>2<?php endif; ?><?php endif; ?></span>
			...
			<?php if ($this->_tpl_vars['complete'] && ! $this->_tpl_vars['edit']): ?>
				...
				<span class="float-right">
					<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_meta' => "cm-ajax", 'but_href' => "checkout.checkout?edit_step=step_three&amp;from_step=".($this->_tpl_vars['edit_step']), 'but_rev' => "checkout_*", 'but_text' => fn_get_lang_var('change', $this->getLanguage()), 'but_role' => 'tool', )); ?>
...
<?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?>
			...
			<a class="title<?php if ($this->_tpl_vars['complete'] && ! $this->_tpl_vars['edit']): ?> cm-ajax cm-ajax-force<?php endif; ?>" <?php if ($this->_tpl_vars['complete'] && ! $this->_tpl_vars['edit']): ?>href="<?php echo fn_url("checkout.checkout?edit_step=step_three&amp;from_step=".($this->_tpl_vars['edit_step'])."&amp;is_ajax=1"); ?>
" rev="checkout_*"<?php endif; ?>><?php echo fn_get_lang_var('shipping_options', $this->getLanguage()); ?>
</a>
			<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_hook($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
		</h2>
	<?php endif; ?>

	<div id="step_three_body" class="step-body<?php if ($this->_tpl_vars['edit']): ?>-active<?php endif; ?> <?php if (! $this->_tpl_vars['edit']): ?>hidden<?php endif; ?> clearfix">
		<?php if ($this->_tpl_vars['edit']): ?>
			<form name="step_three_payment_and_shipping" class="<?php echo $this->_tpl_vars['ajax_form']; ?>
...
" method="<?php if (! $this->_tpl_vars['edit']): ?>get<?php else: ?>post<?php endif; ?>">
				...
				<div class="clearfix">
					...
					<?php $this->_tag_stack[] = array('hook', array('name' => "checkout:select_shipping")); $_block_repeat=true;smarty_block_hook($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
						<?php if (! $this->_tpl_vars['cart']['shipping_failed']): ?>
							<?php $_smarty_tpl_vars = $this->_tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "views/checkout/components/shipping_rates.tpl", 'smarty_include_vars' => array('no_form' => true,'display' => 'radio')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
						<?php else: ?>
							<p class="error-text"><?php echo fn_get_lang_var('text_no_shipping_methods', $this->getLanguage()); ?>
</p>
						<?php endif; ?>
					<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_hook($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
					...
					<?php if ($this->_tpl_vars['edit']): ?>
						<?php $__parent_tpl_vars = $this->_tpl_vars; ?><?php $this->_tag_stack[] = array('hook', array('name' => "checkout:notes")); $_block_repeat=true;smarty_block_hook($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
<div class="customer-notes">
	<p class="strong"><?php echo fn_get_lang_var('type_comments_here', $this->getLanguage()); ?>
</p>
	<textarea class="input-textarea checkout-textarea" name="customer_notes" cols="60" rows="3"><?php echo $this->_tpl_vars['cart']['notes']; ?>
</textarea>
</div>
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_hook($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?>
						...
						<p><?php echo fn_get_lang_var('delivery_times_text', $this->getLanguage()); ?>
</p>
							<?php echo fn_get_lang_var('shipping_tips', $this->getLanguage()); ?>
				...
				<div class="checkout-buttons">
					<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_name' => "dispatch[checkout.update_steps]", 'but_text' => $this->_tpl_vars['but_text'], 'but_id' => 'step_three_but', )); ?>
