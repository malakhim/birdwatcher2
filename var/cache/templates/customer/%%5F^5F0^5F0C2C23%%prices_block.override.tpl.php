<?php /* Smarty version 2.6.18, created on 2013-08-31 09:07:01
...
<?php
fn_preload_lang_vars(array('total_list_price','price_for_all','sign_in_to_view_price'));
?>
<?php  ob_start();  ?><?php 
  ...
  'common_templates/price.tpl' => 1367063745,
			 ...
			 ?><?php if ($this->_tpl_vars['product']['chains'] && $this->_tpl_vars['_REQUEST']['dispatch'] != "wishlist.view"): ?>
	<?php $_from = $this->_tpl_vars['product']['chains']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
