<?php /* Smarty version 2.6.18, created on 2013-08-22 11:43:00
         compiled from buttons/checkout.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'buttons/checkout.tpl', 40, false),array('modifier', 'fn_url', 'buttons/checkout.tpl', 40, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('checkout','delete'));
?>
<?php  ob_start();  ?><?php 
  ...
  'buttons/button.tpl' => 1372320684,
			 ...
			 ?><?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_text' => fn_get_lang_var('checkout', $this->getLanguage()), 'but_onclick' => $this->_tpl_vars['but_onclick'], 'but_href' => $this->_tpl_vars['but_href'], 'but_target' => $this->_tpl_vars['but_target'], 'but_role' => 'action', )); ?>
