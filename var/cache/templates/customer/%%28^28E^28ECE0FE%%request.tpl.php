<?php /* Smarty version 2.6.18, created on 2013-07-14 17:30:27
         compiled from addons/billibuys/views/billibuys/request.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'fn_url', 'addons/billibuys/views/billibuys/request.tpl', 1, false),array('modifier', 'var_dump', 'addons/billibuys/views/billibuys/request.tpl', 15, false),array('modifier', 'replace', 'addons/billibuys/views/billibuys/request.tpl', 42, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('place_bid','delete'));
?>
<?php  ob_start();  ?><?php 
...
<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_text' => fn_get_lang_var('place_bid', $this->getLanguage()), 'but_href' => fn_url("vendor.php?dispatch=billibuys.place_bid&request_id=".($this->_tpl_vars['request']['bb_request_id'])), 'but_role' => 'link', )); ?>
