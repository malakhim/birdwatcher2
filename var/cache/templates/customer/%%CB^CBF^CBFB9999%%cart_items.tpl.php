<?php /* Smarty version 2.6.18, created on 2013-08-31 09:08:49
         compiled from views/checkout/components/cart_items.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'floatval', 'views/checkout/components/cart_items.tpl', 17, false),array('modifier', 'default', 'views/checkout/components/cart_items.tpl', 35, false),array('modifier', 'fn_url', 'views/checkout/components/cart_items.tpl', 43, false),array('modifier', 'unescape', 'views/checkout/components/cart_items.tpl', 134, false),array('modifier', 'fn_generate_thumbnail', 'views/checkout/components/cart_items.tpl', 134, false),array('modifier', 'escape', 'views/checkout/components/cart_items.tpl', 134, false),array('modifier', 'fn_convert_relative_to_absolute_image_url', 'views/checkout/components/cart_items.tpl', 137, false),array('modifier', 'format_price', 'views/checkout/components/cart_items.tpl', 296, false),array('modifier', 'fn_get_company_name', 'views/checkout/components/cart_items.tpl', 339, false),array('modifier', 'trim', 'views/checkout/components/cart_items.tpl', 357, false),array('block', 'hook', 'views/checkout/components/cart_items.tpl', 18, false),array('function', 'math', 'views/checkout/components/cart_items.tpl', 52, false),)), $this); ?>
<?php
...
<?php $this->_tag_stack[] = array('hook', array('name' => "checkout:items_list")); $_block_repeat=true;smarty_block_hook($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
