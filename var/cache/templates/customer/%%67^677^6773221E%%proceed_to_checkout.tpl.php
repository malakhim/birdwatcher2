...
<?php
fn_preload_lang_vars(array('proceed_to_checkout','delete'));
?>
<?php  ob_start();  ?><?php 
  ...
  'buttons/button.tpl' => 1372320684,
			 ...
			 ?><?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_text' => fn_get_lang_var('proceed_to_checkout', $this->getLanguage()), 'but_onclick' => $this->_tpl_vars['but_onclick'], 'but_href' => $this->_tpl_vars['but_href'], 'but_target' => $this->_tpl_vars['but_target'], 'but_role' => 'action', )); ?>
