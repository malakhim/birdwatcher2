<?php /* Smarty version 2.6.18, created on 2013-08-30 14:14:07
         compiled from C:/wamp5/www/dutchme2/skins/basic/customer/blocks/checkout/products_in_cart.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'hook', 'C:/wamp5/www/dutchme2/skins/basic/customer/blocks/checkout/products_in_cart.tpl', 17, false),array('modifier', 'fn_url', 'C:/wamp5/www/dutchme2/skins/basic/customer/blocks/checkout/products_in_cart.tpl', 22, false),array('modifier', 'unescape', 'C:/wamp5/www/dutchme2/skins/basic/customer/blocks/checkout/products_in_cart.tpl', 22, false),array('modifier', 'replace', 'C:/wamp5/www/dutchme2/skins/basic/customer/blocks/checkout/products_in_cart.tpl', 47, false),array('modifier', 'format_price', 'C:/wamp5/www/dutchme2/skins/basic/customer/blocks/checkout/products_in_cart.tpl', 64, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('delete','bundled_products','edit_products'));
?>
<?php 
  ...
  'addons/bundled_products/hooks/block_checkout/product_extra.post.tpl' => 1373106836,
))) {
			 ...
			 ?><div id="checkout_info_products_<?php echo $this->_tpl_vars['block']['snapping_id']; ?>
">
	<ul class="order-product-list">
	<?php $this->_tag_stack[] = array('hook', array('name' => "block_checkout:cart_items")); $_block_repeat=true;smarty_block_hook($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
...
?>
		<?php $this->_tag_stack[] = array('hook', array('name' => "block_checkout:cart_products")); $_block_repeat=true;smarty_block_hook($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
...
" class="product-name"><?php echo smarty_modifier_unescape($this->_tpl_vars['product']['product']); ?>
</a><?php if (! $this->_tpl_vars['product']['exclude_from_calculate']): ?><?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_href' => "checkout.delete?cart_id=".($this->_tpl_vars['key'])."&amp;redirect_mode=".($this->_tpl_vars['mode']), 'but_meta' => 'delete', 'but_rev' => "cart_status*", 'but_role' => 'delete', 'but_name' => 'delete_cart_item', )); ?>
...
?>
	...
	<?php if ($this->_smarty_vars['capture']['is_conf_prod']): ?>
		<div class="info-block buy-together">
			...
			<h2><?php echo fn_get_lang_var('bundled_products', $this->getLanguage()); ?>
</h2>
			<ul>
				<?php $_from = $this->_tpl_vars['cart_products']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key_conf'] => $this->_tpl_vars['_product']):
?>
					<?php if ($this->_tpl_vars['cart']['products'][$this->_tpl_vars['key_conf']]['extra']['parent']['bundled_products'] == $this->_tpl_vars['key']): ?>
						<li><?php echo smarty_modifier_unescape($this->_tpl_vars['_product']['product']); ?>
</li>
					<?php endif; ?>
				<?php endforeach; endif; unset($_from); ?>
			</ul>
...
<?php endif; ?><?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?><?php endif; ?><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_hook($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
	...
	<?php endforeach; endif; unset($_from); ?>
	<?php if ($this->_tpl_vars['addons']['gift_certificates']['status'] == 'A'): ?><?php $_smarty_tpl_vars = $this->_tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "addons/gift_certificates/hooks/block_checkout/cart_items.post.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
...
<div class="edit-products"><a href="<?php echo fn_url("checkout.cart"); ?>
" rel="nofollow" class="text-button"><?php echo fn_get_lang_var('edit_products', $this->getLanguage()); ?>
</a></div>
<!--checkout_info_products_<?php echo $this->_tpl_vars['block']['snapping_id']; ?>
--></div>