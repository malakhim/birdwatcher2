...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'trim', 'views/pages/view.tpl', 2, false),array('modifier', 'unescape', 'views/pages/view.tpl', 3, false),array('block', 'hook', 'views/pages/view.tpl', 2, false),array('function', 'set_id', 'views/pages/view.tpl', 9, false),)), $this); ?>
<?php ob_start(); ?><div class="wysiwyg-content">
...
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php endif; ?><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_hook($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php $this->_smarty_vars['capture']['template_content'] = ob_get_contents(); ob_end_clean(); ?><?php if (trim($this->_smarty_vars['capture']['template_content'])): ?><?php if ($this->_tpl_vars['auth']['area'] == 'A'): ?><span class="cm-template-box" template="views/pages/view.tpl" id="<?php echo smarty_function_set_id(array('name' => "views/pages/view.tpl"), $this);?>
