<?php /* Smarty version 2.6.18, created on 2013-08-31 09:05:32
         compiled from views/checkout/components/checkout_login.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'hook', 'views/checkout/components/checkout_login.tpl', 53, false),array('modifier', 'replace', 'views/checkout/components/checkout_login.tpl', 88, false),array('modifier', 'fn_url', 'views/checkout/components/checkout_login.tpl', 88, false),array('modifier', 'fn_query_remove', 'views/checkout/components/checkout_login.tpl', 169, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('register','delete','email','checkout_as_guest','delete','new_customer','register','create_new_account','checkout_as_guest','create_guest_account'));
?>
<?php 
...
<?php echo $this->_tpl_vars['ldelim']; ?>
	...
	<?php if ($this->_tpl_vars['checkout_type'] == 'classic'): ?>
		<?php echo '
...
//]]>
	...
	<?php $this->_tag_stack[] = array('hook', array('name' => "checkout:login_form")); $_block_repeat=true;smarty_block_hook($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	<div class="login-form">
		<?php $_smarty_tpl_vars = $this->_tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "views/auth/login_form.tpl", 'smarty_include_vars' => array('form_name' => 'step_one_login_form','result_ids' => "checkout*,account*",'id' => 'checkout')));
...
unset($_smarty_tpl_vars);
 ?>		
	...
	<?php $this->_tag_stack[] = array('hook', array('name' => "checkout:register_customer")); $_block_repeat=true;smarty_block_hook($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	<div class="checkout-register">
		<?php ob_start(); ?>
			<?php if ($this->_tpl_vars['settings']['General']['approve_user_profiles'] != 'Y'): ?>
				<div id="register_checkout" class="checkout-buttons"><?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_href' => ($this->_tpl_vars['curl'])."&amp;login_type=register", 'but_onclick' => "$.processNotifications(); fn_switch_checkout_type(true);", 'but_text' => fn_get_lang_var('register', $this->getLanguage()), )); ?>
...
<?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?></div>
			<?php endif; ?>
		<?php $this->_smarty_vars['capture']['register'] = ob_get_contents(); ob_end_clean(); ?>
		
		<?php ob_start(); ?>
			<?php if ($this->_tpl_vars['settings']['General']['disable_anonymous_checkout'] != 'Y'): ?>
				<div id="anonymous_checkout" class="cm-noscript">
					<form name="step_one_anonymous_checkout_form" class="<?php echo $this->_tpl_vars['ajax_form']; ?>
" action="<?php echo fn_url(""); ?>
" method="post">
						<input type="hidden" name="result_ids" value="checkout*,account*" />

						<?php if (! $this->_tpl_vars['contact_fields_filled']): ?>
							<div class="form-field">
								<label for="guest_email" class="cm-required"><?php echo fn_get_lang_var('email', $this->getLanguage()); ?>
</label>
						...
						<div class="checkout-buttons">
							<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_name' => "dispatch[checkout.customer_info.guest_checkout]", 'but_text' => fn_get_lang_var('checkout_as_guest', $this->getLanguage()), )); ?>
...
<?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?>
			...
			<?php endif; ?>
		<?php $this->_smarty_vars['capture']['anonymous'] = ob_get_contents(); ob_end_clean(); ?>

		<div class="register-content">
			<?php if ($this->_tpl_vars['settings']['General']['approve_user_profiles'] != 'Y' || $this->_tpl_vars['settings']['General']['disable_anonymous_checkout'] != 'Y'): ?>
				<?php $_smarty_tpl_vars = $this->_tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "common_templates/subheader.tpl", 'smarty_include_vars' => array('title' => fn_get_lang_var('new_customer', $this->getLanguage()))));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
			...
			<ul class="register-methods">
				<li class="one"><input class="radio valign" type="radio" id="checkout_type_register" name="checkout_type" value="" checked="checked" onclick="fn_show_checkout_buttons('register')" /><div class="radio1"><label for="checkout_type_register"><span class="method-title"><?php echo fn_get_lang_var('register', $this->getLanguage()); ?>
</span><span class="method-hint"><?php echo fn_get_lang_var('create_new_account', $this->getLanguage()); ?>
</span></label></div></li>

				<?php if ($this->_tpl_vars['settings']['General']['disable_anonymous_checkout'] != 'Y'): ?>
					<li><input class="radio valign" type="radio" id="checkout_type_guest" name="checkout_type" value="" onclick="fn_show_checkout_buttons('guest')" /><div class="radio1"><label for="checkout_type_guest"><span class="method-title"><?php echo fn_get_lang_var('checkout_as_guest', $this->getLanguage()); ?>
</span><span class="method-hint"><?php echo fn_get_lang_var('create_guest_account', $this->getLanguage()); ?>
</span></label></div></li>
				<?php endif; ?>
			</ul>
		</div>

		<?php echo $this->_smarty_vars['capture']['register']; ?>

		<?php echo $this->_smarty_vars['capture']['anonymous']; ?>
