<?php /* Smarty version 2.6.18, created on 2013-09-21 20:01:55
         compiled from buttons/clear_cart.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'buttons/clear_cart.tpl', 40, false),array('modifier', 'fn_url', 'buttons/clear_cart.tpl', 40, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('clear_cart','delete'));
?>
<?php  ob_start();  ?><?php 
  ...
  'buttons/button.tpl' => 1372320684,
			 ...
			 ?><?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_text' => fn_get_lang_var('clear_cart', $this->getLanguage()), 'but_name' => $this->_tpl_vars['but_name'], 'but_onclick' => $this->_tpl_vars['but_onclick'], 'but_href' => $this->_tpl_vars['but_href'], 'but_target' => $this->_tpl_vars['but_target'], 'but_role' => $this->_tpl_vars['but_role'], )); ?>
