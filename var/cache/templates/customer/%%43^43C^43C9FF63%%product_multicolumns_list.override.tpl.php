<?php /* Smarty version 2.6.18, created on 2013-06-14 13:39:30
         compiled from addons/age_verification/hooks/products/product_multicolumns_list.override.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'fn_url', 'addons/age_verification/hooks/products/product_multicolumns_list.override.tpl', 20, false),array('modifier', 'unescape', 'addons/age_verification/hooks/products/product_multicolumns_list.override.tpl', 20, false),array('modifier', 'replace', 'addons/age_verification/hooks/products/product_multicolumns_list.override.tpl', 53, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('sku','product_need_age_verification','verify','delete'));
?>
<?php  ob_start();  ?><?php 
  ...
  'buttons/button.tpl' => 1367063745,
			 ...
			 ?><?php if (! $_SESSION['auth']['age'] && $this->_tpl_vars['product']['age_verification'] == 'Y'): ?>
<?php $this->assign('obj_id', ($this->_tpl_vars['obj_prefix']).($this->_tpl_vars['product']['product_id']), false); ?>
...
" class="product-title"><?php echo smarty_modifier_unescape($this->_tpl_vars['product']['product']); ?>
		...
		<?php if ($this->_tpl_vars['product']['product_code'] || ! $this->_tpl_vars['no_ids']): ?>
		<p class="sku<?php if (! $this->_tpl_vars['product']['product_code']): ?> hidden<?php endif; ?>" <?php if (! $this->_tpl_vars['no_ids']): ?>id="sku_<?php echo $this->_tpl_vars['obj_id']; ?>
"<?php endif; ?>><?php echo fn_get_lang_var('sku', $this->getLanguage()); ?>
: <?php if (! $this->_tpl_vars['no_ids']): ?><span id="product_code_<?php echo $this->_tpl_vars['obj_id']; ?>
"><?php endif; ?><?php echo $this->_tpl_vars['product']['product_code']; ?>
<?php if (! $this->_tpl_vars['no_ids']): ?></span><?php endif; ?></p>
		<?php endif; ?>
		<div class="box margin-top">
			<?php echo fn_get_lang_var('product_need_age_verification', $this->getLanguage()); ?>

			<div class="buttons-container">
				<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_text' => fn_get_lang_var('verify', $this->getLanguage()), 'but_href' => "products.view?product_id=".($this->_tpl_vars['product']['product_id']), 'but_role' => 'text', )); ?>
