<?php /* Smarty version 2.6.18, created on 2014-03-10 11:34:59
         compiled from views/checkout/complete.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'fn_url', 'views/checkout/complete.tpl', 1, false),array('modifier', 'unescape', 'views/checkout/complete.tpl', 18, false),array('modifier', 'replace', 'views/checkout/complete.tpl', 75, false),array('block', 'hook', 'views/checkout/complete.tpl', 23, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('payment_instructions','create_account','username','password','confirm_password','create','delete','my_order_details','delete','my_order_details','delete','order'));
?>
<?php 
...
<?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?>
	...
	<div class="float-right">
				<?php $_smarty_tpl_vars = $this->_tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "buttons/continue_shopping.tpl", 'smarty_include_vars' => array('but_role' => 'text','but_meta' => "text-button-vmid",'but_href' => fn_url("billibuys.view"))));
