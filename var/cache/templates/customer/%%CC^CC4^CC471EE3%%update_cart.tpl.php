<?php /* Smarty version 2.6.18, created on 2013-08-31 09:08:49
         compiled from buttons/update_cart.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'buttons/update_cart.tpl', 42, false),array('modifier', 'fn_url', 'buttons/update_cart.tpl', 42, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('recalculate','delete'));
?>
<?php  ob_start();  ?><?php 
  ...
  'buttons/button.tpl' => 1372320684,
			 ...
			 ?>
<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_id' => $this->_tpl_vars['but_id'], 'but_text' => fn_get_lang_var('recalculate', $this->getLanguage()), 'but_onclick' => $this->_tpl_vars['but_onclick'], 'but_href' => $this->_tpl_vars['but_href'], 'but_target' => $this->_tpl_vars['but_target'], 'but_role' => $this->_tpl_vars['but_role'], )); ?>
