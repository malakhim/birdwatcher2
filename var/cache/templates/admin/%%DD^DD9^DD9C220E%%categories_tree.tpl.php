<?php /* Smarty version 2.6.18, created on 2013-10-28 17:42:57
...
" size="3" class="input-text-short " disabled=disabled/></td>
		<td width="57%">
		<?php echo '<span class="strong" style="padding-left: '; ?><?php echo $this->_tpl_vars['shift']; ?><?php echo 'px;">'; ?><?php if ($this->_tpl_vars['category']['has_children'] || $this->_tpl_vars['category']['subcategories']): ?><?php echo ''; ?><?php if ($this->_tpl_vars['show_all']): ?><?php echo '<img src="'; ?><?php echo $this->_tpl_vars['images_dir']; ?><?php echo '/plus.gif" width="14" height="9" border="0" alt="'; ?><?php echo fn_get_lang_var('expand_sublist_of_items', $this->getLanguage()); ?><?php echo '" title="'; ?><?php echo fn_get_lang_var('expand_sublist_of_items', $this->getLanguage()); ?><?php echo '" id="on_'; ?><?php echo $this->_tpl_vars['comb_id']; ?><?php echo '" class="hand cm-combination '; ?><?php if ($this->_tpl_vars['expand_all']): ?><?php echo 'hidden'; ?><?php endif; ?><?php echo '" />'; ?><?php else: ?><?php echo '<img src="'; ?><?php echo $this->_tpl_vars['images_dir']; ?><?php echo '/plus.gif" width="14" height="9" border="0" alt="'; ?><?php echo fn_get_lang_var('expand_sublist_of_items', $this->getLanguage()); ?><?php echo '" title="'; ?><?php echo fn_get_lang_var('expand_sublist_of_items', $this->getLanguage()); ?><?php echo '" id="on_'; ?><?php echo $this->_tpl_vars['comb_id']; ?><?php echo '" class="hand cm-combination" onclick="if (!$(\'#'; ?><?php echo $this->_tpl_vars['comb_id']; ?><?php echo '\').children().get(0)) $.ajaxRequest(\''; ?><?php echo fn_url("categories.manage?category_id=".($this->_tpl_vars['category']['bb_request_category_id']), 'A', 'rel', '&'); ?><?php echo '\', '; ?><?php echo $this->_tpl_vars['ldelim']; ?><?php echo 'result_ids: \''; ?><?php echo $this->_tpl_vars['comb_id']; ?><?php echo '\''; ?><?php echo $this->_tpl_vars['rdelim']; ?><?php echo ')" />'; ?><?php endif; ?><?php echo '<img src="'; ?><?php echo $this->_tpl_vars['images_dir']; ?><?php echo '/minus.gif" width="14" height="9" border="0" alt="'; ?><?php echo fn_get_lang_var('collapse_sublist_of_items', $this->getLanguage()); ?><?php echo '" title="'; ?><?php echo fn_get_lang_var('collapse_sublist_of_items', $this->getLanguage()); ?><?php echo '" id="off_'; ?><?php echo $this->_tpl_vars['comb_id']; ?><?php echo '" class="hand cm-combination'; ?><?php if (! $this->_tpl_vars['expand_all'] || ! $this->_tpl_vars['show_all']): ?><?php echo ' hidden'; ?><?php endif; ?><?php echo '" />&nbsp;'; ?><?php endif; ?><?php echo '<a href="'; ?><?php echo fn_url("billibuys.category_update?category_id=".($this->_tpl_vars['category']['bb_request_category_id'])); ?><?php echo '"'; ?><?php if ($this->_tpl_vars['category']['status'] == 'N'): ?><?php echo ' class="manage-root-item-disabled"'; ?><?php endif; ?><?php echo ''; ?><?php if (! $this->_tpl_vars['category']['subcategories']): ?><?php echo ' style="padding-left: 14px;" class="normal"'; ?><?php endif; ?><?php echo ' >'; ?><?php echo $this->_tpl_vars['category']['category_name']; ?><?php echo ' '; ?><?php echo '</a>'; ?><?php if ($this->_tpl_vars['category']['status'] == 'N'): ?><?php echo '&nbsp;<span class="small-note">-&nbsp;['; ?><?php echo fn_get_lang_var('disabled', $this->getLanguage()); ?><?php echo ']</span>'; ?><?php endif; ?><?php echo '</span>'; ?>
...
<?php endif; ?><?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?>
		...
		<td width="10%" class="nowrap">
				...
				<?php ob_start(); ?>
				<li><?php if (! $this->_tpl_vars['category']['product_count']): ?><a class="cm-confirm" href="<?php echo fn_url("billibuys.category_delete?category_id=".($this->_tpl_vars['category']['bb_request_category_id'])); ?>
