<?php /* Smarty version 2.6.18, created on 2014-03-06 22:16:31
         compiled from addons/billibuys/views/billibuys/place_bid.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'addons/billibuys/views/billibuys/place_bid.tpl', 1, false),array('modifier', 'fn_url', 'addons/billibuys/views/billibuys/place_bid.tpl', 1, false),array('modifier', 'fn_query_remove', 'addons/billibuys/views/billibuys/place_bid.tpl', 29, false),array('modifier', 'unescape', 'addons/billibuys/views/billibuys/place_bid.tpl', 79, false),array('modifier', 'fn_generate_thumbnail', 'addons/billibuys/views/billibuys/place_bid.tpl', 79, false),array('modifier', 'escape', 'addons/billibuys/views/billibuys/place_bid.tpl', 79, false),array('modifier', 'fn_get_company_name', 'addons/billibuys/views/billibuys/place_bid.tpl', 104, false),array('modifier', 'fn_format_price', 'addons/billibuys/views/billibuys/place_bid.tpl', 112, false),array('modifier', 'fn_check_view_permissions', 'addons/billibuys/views/billibuys/place_bid.tpl', 167, false),array('modifier', 'substr_count', 'addons/billibuys/views/billibuys/place_bid.tpl', 246, false),array('modifier', 'replace', 'addons/billibuys/views/billibuys/place_bid.tpl', 247, false),array('modifier', 'defined', 'addons/billibuys/views/billibuys/place_bid.tpl', 259, false),array('function', 'cycle', 'addons/billibuys/views/billibuys/place_bid.tpl', 54, false),array('function', 'math', 'addons/billibuys/views/billibuys/place_bid.tpl', 73, false),array('block', 'hook', 'addons/billibuys/views/billibuys/place_bid.tpl', 225, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('check_uncheck_all','position_short','image','name','product_code','price','list_price','purchased_qty','subtotal_sum','quantity','vendor','supplier','product_code','update_for_all_hid_act','update_for_all_hid_dis','update_for_all_act','update_for_all_dis','edit','remove_this_item','remove_this_item','no_data','select_all','unselect_all','clone_selected','export_selected','delete_selected','edit_selected','btn_place_bid_txt','select_fields_to_edit','create_product_package','or','tools','add','products'));
?>
<?php 
...
<div class="buttons-container buttons-bg">
	...
	<?php $_smarty_tpl_vars = $this->_tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "buttons/save_cancel.tpl", 'smarty_include_vars' => array('but_text' => fn_get_lang_var('btn_place_bid_txt', $this->getLanguage()),'but_name' => "dispatch[billibuys.place_bid]",'hide_second_button' => true,'cancel_action' => 'close')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
	</div>
