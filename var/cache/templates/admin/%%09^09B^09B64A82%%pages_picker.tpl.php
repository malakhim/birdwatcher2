<?php /* Smarty version 2.6.18, created on 2013-09-21 19:31:58
         compiled from pickers/pages_picker.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'fn_url', 'pickers/pages_picker.tpl', 1, false),array('modifier', 'default', 'pickers/pages_picker.tpl', 15, false),array('modifier', 'is_array', 'pickers/pages_picker.tpl', 24, false),array('modifier', 'explode', 'pickers/pages_picker.tpl', 25, false),array('modifier', 'implode', 'pickers/pages_picker.tpl', 45, false),array('modifier', 'fn_get_page_name', 'pickers/pages_picker.tpl', 54, false),array('modifier', 'escape', 'pickers/pages_picker.tpl', 63, false),array('modifier', 'fn_check_view_permissions', 'pickers/pages_picker.tpl', 201, false),array('function', 'math', 'pickers/pages_picker.tpl', 16, false),array('function', 'script', 'pickers/pages_picker.tpl', 22, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('position_short','name','no_items','add_pages','choose','choose','remove_this_item','remove_this_item','add_pages'));
?>
<?php  ob_start();  ?><?php 
  ...
  'buttons/button.tpl' => 1367063752,
			 ...
			 ?><?php $this->assign('data_id', smarty_modifier_default(@$this->_tpl_vars['data_id'], 'pages_list'), false); ?>
...
<?php $this->assign('miltiple', smarty_modifier_default(@$this->_tpl_vars['multiple'], true), false); ?>
...
" class="<?php if ($this->_tpl_vars['multiple'] && ! $this->_tpl_vars['item_ids']): ?>hidden<?php elseif (! $this->_tpl_vars['multiple']): ?>cm-display-radio float-left<?php endif; ?>">
	...
	<?php endif; ?>
	<input id="a<?php echo $this->_tpl_vars['data_id']; ?>
_ids" type="hidden" class="cm-picker-value" name="<?php echo $this->_tpl_vars['input_name']; ?>
...
?>
		<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('page_id' => $this->_tpl_vars['p_id'], 'holder' => $this->_tpl_vars['data_id'], 'input_name' => $this->_tpl_vars['input_name'], 'hide_link' => $this->_tpl_vars['hide_link'], 'hide_delete_button' => $this->_tpl_vars['hide_delete_button'], 'hide_input' => true, 'first_item' => ($this->_foreach['items']['iteration'] <= 1), 'position_field' => $this->_tpl_vars['positions'], 'position' => $this->_foreach['items']['iteration']+$this->_tpl_vars['start_pos'], )); ?><?php if ($this->_tpl_vars['page_id']): ?>
	<?php $this->assign('page', smarty_modifier_default(fn_get_page_name($this->_tpl_vars['page_id']), ($this->_tpl_vars['ldelim'])."page".($this->_tpl_vars['rdelim'])), false); ?>
<?php else: ?>
	<?php $this->assign('page', $this->_tpl_vars['default_name'], false); ?>
<?php endif; ?>

<?php if ($this->_tpl_vars['multiple']): ?>
<tr <?php if (! $this->_tpl_vars['clone']): ?>id="<?php echo $this->_tpl_vars['holder']; ?>
_<?php echo $this->_tpl_vars['page_id']; ?>
...
" size="3" class="input-text-short"<?php if ($this->_tpl_vars['clone']): ?> disabled="disabled"<?php endif; ?> /></td><?php endif; ?>
	...
	<td><a href="<?php echo fn_url("pages.update?page_id=".($this->_tpl_vars['page_id'])); ?>
"><?php echo smarty_modifier_escape($this->_tpl_vars['page']); ?>
</a></td>

	<td><?php if (! $this->_tpl_vars['hide_delete_button'] && ! $this->_tpl_vars['view_only']): ?>
		<a onclick="$.delete_js_item('<?php echo $this->_tpl_vars['holder']; ?>
', '<?php echo $this->_tpl_vars['page_id']; ?>
', 'a'); return false;"><img width="12" height="18" border="0" class="hand valign" alt="" src="<?php echo $this->_tpl_vars['images_dir']; ?>
/icons/icon_delete.gif"/></a>
		<?php else: ?>&nbsp;<?php endif; ?>
	</td>
	<?php if (! $this->_tpl_vars['hide_input']): ?>
		<input <?php if ($this->_tpl_vars['input_id']): ?>id="<?php echo $this->_tpl_vars['input_id']; ?>
"<?php endif; ?> type="hidden" name="<?php echo $this->_tpl_vars['input_name']; ?>
" value="<?php echo $this->_tpl_vars['page_id']; ?>
" />
	<?php endif; ?>
</tr>
<?php else: ?>
...
" <?php endif; ?>class="cm-js-item no-margin<?php if ($this->_tpl_vars['clone']): ?> cm-clone hidden<?php endif; ?>">
	...
	<input class="input-text-medium cm-picker-value-description" type="text" value="<?php echo smarty_modifier_escape($this->_tpl_vars['page']); ?>
" <?php if ($this->_tpl_vars['display_input_id']): ?>id="<?php echo $this->_tpl_vars['display_input_id']; ?>
"<?php endif; ?> size="10" name="page_name" readonly="readonly" <?php echo $this->_tpl_vars['extra']; ?>
 />
	</<?php if ($this->_tpl_vars['single_line']): ?>span<?php else: ?>p<?php endif; ?>>
<?php endif; ?><?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?>
	<?php endforeach; endif; unset($_from); ?>
	<?php elseif (! $this->_tpl_vars['multiple']): ?>
		<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('page_id' => "", 'holder' => $this->_tpl_vars['data_id'], 'input_name' => $this->_tpl_vars['input_name'], 'hide_link' => $this->_tpl_vars['hide_link'], 'hide_delete_button' => $this->_tpl_vars['hide_delete_button'], )); ?><?php if ($this->_tpl_vars['page_id']): ?>
	<?php $this->assign('page', smarty_modifier_default(fn_get_page_name($this->_tpl_vars['page_id']), ($this->_tpl_vars['ldelim'])."page".($this->_tpl_vars['rdelim'])), false); ?>
<?php else: ?>
	<?php $this->assign('page', $this->_tpl_vars['default_name'], false); ?>
<?php endif; ?>
...
<?php endif; ?><?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?>
	...
	<?php if ($this->_tpl_vars['multiple']): ?>
		<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('page_id' => ($this->_tpl_vars['ldelim'])."page_id".($this->_tpl_vars['rdelim']), 'holder' => $this->_tpl_vars['data_id'], 'input_name' => $this->_tpl_vars['input_name'], 'clone' => true, 'hide_link' => $this->_tpl_vars['hide_link'], 'hide_delete_button' => $this->_tpl_vars['hide_delete_button'], 'hide_input' => true, 'position_field' => $this->_tpl_vars['positions'], 'position' => '0', )); ?><?php if ($this->_tpl_vars['page_id']): ?>
	<?php $this->assign('page', smarty_modifier_default(fn_get_page_name($this->_tpl_vars['page_id']), ($this->_tpl_vars['ldelim'])."page".($this->_tpl_vars['rdelim'])), false); ?>
<?php else: ?>
	<?php $this->assign('page', $this->_tpl_vars['default_name'], false); ?>
<?php endif; ?>
...
<?php if ($this->_tpl_vars['view_mode'] != 'list'): ?>
	...
	<?php if (! $this->_tpl_vars['no_container']): ?><div class="<?php if (! $this->_tpl_vars['multiple']): ?>choose-icon<?php else: ?>buttons-container<?php endif; ?>"><?php endif; ?>
		<?php if ($this->_tpl_vars['multiple']): ?>
			<?php $this->assign('_but_text', smarty_modifier_default(@$this->_tpl_vars['but_text'], fn_get_lang_var('add_pages', $this->getLanguage())), false); ?>
		...
		<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_id' => "opener_picker_".($this->_tpl_vars['data_id']), 'but_href' => fn_url("pages.picker?display=".($this->_tpl_vars['display'])."&amp;picker_for=".($this->_tpl_vars['picker_for'])."&amp;extra=".($this->_tpl_vars['extra_var'])."&amp;checkbox_name=".($this->_tpl_vars['checkbox_name'])."&amp;root=".($this->_tpl_vars['default_name'])."&amp;except_id=".($this->_tpl_vars['except_id'])."&amp;data_id=".($this->_tpl_vars['data_id']).($this->_tpl_vars['extra_url'])."&amp;company_id=".($this->_tpl_vars['company_id'])), 'but_text' => $this->_tpl_vars['_but_text'], 'but_role' => $this->_tpl_vars['_but_role'], 'but_rev' => "content_".($this->_tpl_vars['data_id']), 'but_meta' => "cm-dialog-opener", )); ?><?php if ($this->_tpl_vars['but_role'] == 'text'): ?>
...
" title="<?php echo smarty_modifier_default(@$this->_tpl_vars['but_text'], fn_get_lang_var('add_pages', $this->getLanguage())); ?>
">
	</div>
