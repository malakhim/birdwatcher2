<?php /* Smarty version 2.6.18, created on 2014-03-07 12:48:32
         compiled from buttons/search.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'buttons/search.tpl', 38, false),array('modifier', 'fn_check_view_permissions', 'buttons/search.tpl', 39, false),array('modifier', 'fn_url', 'buttons/search.tpl', 45, false),)), $this); ?>
<?php
...
<?php  ob_start();  ?><?php 
  ...
  'buttons/button.tpl' => 1367063752,
			 ...
			 ?><?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_text' => fn_get_lang_var('search', $this->getLanguage()), 'but_onclick' => $this->_tpl_vars['but_onclick'], 'but_href' => $this->_tpl_vars['but_href'], 'but_role' => $this->_tpl_vars['but_role'], )); ?><?php if ($this->_tpl_vars['but_role'] == 'text'): ?>
