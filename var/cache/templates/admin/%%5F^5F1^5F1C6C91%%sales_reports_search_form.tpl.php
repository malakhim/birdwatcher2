...
" method="post" name="report_form_<?php echo $this->_tpl_vars['report']['report_id']; ?>
">
<input type="hidden" name="report_id" value="<?php echo $this->_tpl_vars['report']['report_id']; ?>
" />
<input type="hidden" name="selected_section" value="" />

<?php $_smarty_tpl_vars = $this->_tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "common_templates/period_selector.tpl", 'smarty_include_vars' => array('period' => $this->_tpl_vars['period'],'form_name' => 'orders_search_form','display' => 'form','but_name' => "dispatch[sales_reports.set_report_view]")));
