<?php /* Smarty version 2.6.18, created on 2013-10-19 17:51:53
         compiled from addons/billibuys/views/billibuys/category_add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'addons/billibuys/views/billibuys/category_add.tpl', 1, false),array('modifier', 'fn_get_usergroups', 'addons/billibuys/views/billibuys/category_add.tpl', 1, false),array('modifier', 'fn_url', 'addons/billibuys/views/billibuys/category_add.tpl', 17, false),array('modifier', 'fn_check_form_permissions', 'addons/billibuys/views/billibuys/category_add.tpl', 17, false),array('modifier', 'fn_show_picker', 'addons/billibuys/views/billibuys/category_add.tpl', 33, false),array('modifier', 'fn_bb_get_categories', 'addons/billibuys/views/billibuys/category_add.tpl', 40, false),array('modifier', 'strpos', 'addons/billibuys/views/billibuys/category_add.tpl', 41, false),array('modifier', 'indent', 'addons/billibuys/views/billibuys/category_add.tpl', 42, false),array('modifier', 'is_array', 'addons/billibuys/views/billibuys/category_add.tpl', 81, false),array('modifier', 'fn_from_json', 'addons/billibuys/views/billibuys/category_add.tpl', 82, false),array('modifier', 'lower', 'addons/billibuys/views/billibuys/category_add.tpl', 85, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('general','name','location','root_level','location','root_level','description','active','hidden','disabled','status','active','hidden','disabled','status','active','hidden','pending','disabled','images','text_category_icon','text_category_detailed_image','add_categories'));
?>
<?php 
...
" <?php if ($this->_tpl_vars['cat']['disabled']): ?>disabled="disabled"<?php endif; ?> <?php if ($this->_tpl_vars['category_data']['parent_id'] == $this->_tpl_vars['cat']['bb_request_category_id']): ?>selected="selected"<?php endif; ?>><?php echo smarty_modifier_indent($this->_tpl_vars['cat']['category_name'], $this->_tpl_vars['cat']['level'], "&#166;&nbsp;&nbsp;&nbsp;&nbsp;", "&#166;--&nbsp;"); ?>
</option>
					<?php endif; ?>
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;$this->_smarty_include(array('smarty_include_tpl_file' => "common_templates/mainbox.tpl", 'smarty_include_vars' => array('title' => fn_get_lang_var('add_categories', $this->getLanguage()),'content' => $this->_smarty_vars['capture']['mainbox'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>