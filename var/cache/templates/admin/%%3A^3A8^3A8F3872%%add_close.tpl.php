...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'buttons/add_close.tpl', 39, false),array('modifier', 'fn_check_view_permissions', 'buttons/add_close.tpl', 40, false),array('modifier', 'fn_url', 'buttons/add_close.tpl', 46, false),)), $this); ?>
<?php
fn_preload_lang_vars(array('remove_this_item','remove_this_item','remove_this_item','remove_this_item','remove_this_item','remove_this_item','or','cancel'));
?>
<?php  ob_start();  ?><?php 
  ...
  'buttons/button.tpl' => 1367063752,
			 ...
			 ?><?php if ($this->_tpl_vars['is_js'] == true): ?>
	<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_name' => 'submit', 'but_text' => $this->_tpl_vars['but_close_text'], 'but_onclick' => $this->_tpl_vars['but_close_onclick'], 'but_role' => 'button_main', 'but_meta' => "cm-process-items cm-dialog-closer", )); ?><?php if ($this->_tpl_vars['but_role'] == 'text'): ?>
...
<?php endif; ?><?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?>
	...
	<?php if ($this->_tpl_vars['but_text']): ?>
		<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_name' => "", 'but_text' => $this->_tpl_vars['but_text'], 'but_onclick' => $this->_tpl_vars['but_onclick'], 'but_role' => 'submit', 'but_meta' => "cm-process-items", )); ?><?php if ($this->_tpl_vars['but_role'] == 'text'): ?>
	<?php $this->assign('class', "text-link", false); ?>
<?php elseif ($this->_tpl_vars['but_role'] == 'delete'): ?>
	<?php $this->assign('class', "text-button-delete", false); ?>
<?php elseif ($this->_tpl_vars['but_role'] == 'add'): ?>
...
<?php endif; ?><?php if (isset($__parent_tpl_vars)) { $this->_tpl_vars = $__parent_tpl_vars; unset($__parent_tpl_vars);} ?>
	<?php endif; ?>
<?php else: ?>
	<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_name' => 'submit', 'but_text' => $this->_tpl_vars['but_close_text'], 'but_role' => 'button_main', 'but_meta' => "cm-process-items", )); ?><?php if ($this->_tpl_vars['but_role'] == 'text'): ?>
	<?php $this->assign('class', "text-link", false); ?>
<?php elseif ($this->_tpl_vars['but_role'] == 'delete'): ?>
	<?php $this->assign('class', "text-button-delete", false); ?>
<?php elseif ($this->_tpl_vars['but_role'] == 'add'): ?>
...
&nbsp;&nbsp;<a class="cm-dialog-closer tool-link"><?php echo fn_get_lang_var('cancel', $this->getLanguage()); ?>
</a><?php  ob_end_flush();  ?>