...
<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_onclick' => $this->_smarty_vars['capture']['pop'], 'but_href' => $this->_tpl_vars['but_href'], 'but_text' => $this->_tpl_vars['but_text'], )); ?><?php if ($this->_tpl_vars['but_role'] == 'text'): ?>
