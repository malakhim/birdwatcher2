...
>
					<td>
						<?php $this->assign('request_id', $this->_tpl_vars['request']['bb_request_id'], false); ?>
						<?php $__parent_tpl_vars = $this->_tpl_vars;$this->_tpl_vars = array_merge($this->_tpl_vars, array('but_text' => $this->_tpl_vars['request']['title'], 'but_href' => fn_url("billibuys.request&request_id=".($this->_tpl_vars['request_id'])), 'but_role' => 'link', )); ?><?php if ($this->_tpl_vars['but_role'] == 'text'): ?>
