...
{if $feature.feature_type == "S" || $feature.feature_type == "N" || $feature.feature_type == "E"}
	{if $feature.use_variant_picker}
		...
		{/if}
		{include file="common_templates/ajax_select_object.tpl" data_url="product_features.get_feature_variants_list&feature_id=`$feature.feature_id`&enter_other=N" text=$selected_variant result_elm=$input_id id="`$feature.feature_id`_selector_`$suffix`"}
	{else}
