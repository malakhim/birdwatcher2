{if $override_box}
	...
	{include file="common_templates/ajax_select_object.tpl" data_url="companies.get_companies_list" text=$product.$field|fn_get_company_name result_elm=$result_id id="prod_`$product.product_id`"}