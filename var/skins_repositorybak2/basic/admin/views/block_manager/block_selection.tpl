...
<div class="tabs cm-j-tabs">
	<ul>
		<li id="user_existing_blocks_{$grid_id}{$extra_id}" class="cm-js cm-active"><a>{if $smarty.request.manage && $smarty.request.manage == "Y"}{$lang.manage_existing_block}{else}{$lang.use_existing_block}{/if}</a></li>
		<li id="create_new_blocks_{$grid_id}{$extra_id}" class="cm-js"><a>{$lang.create_new_block}</a></li>
	</ul>
</div>
