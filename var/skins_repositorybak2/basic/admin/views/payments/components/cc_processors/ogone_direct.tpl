...
<div class="form-field">
	<label for="userid">{$lang.user_id}:</label>
	<input type="text" name="payment_data[processor_params][userid]" id="userid" size="60" value="{$processor_params.userid}" class="input-text" />
</div>
