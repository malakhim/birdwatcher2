...
<script type="text/javascript" src="{$config.http_location}/lib/jquery/jquery.js"></script>
<script type="text/javascript" src="{$config.http_location}/js/core.js"></script>
