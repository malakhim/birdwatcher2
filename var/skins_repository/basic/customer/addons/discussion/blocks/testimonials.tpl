...
{assign var="posts" value=0|fn_get_discussion_posts:0:$block.properties.limit:$block.properties.random}

{if $posts}
{foreach from=$posts item=post}

{if $discussion.type == "C" || $discussion.type == "B"}
	<p class="post-message"><a href="{"discussion.view?thread_id=`$discussion.thread_id`&amp;post_id=`$post.post_id`"|fn_url}">"{$post.message|truncate:100|escape:'html'|nl2br}"</a></p>
{/if}
