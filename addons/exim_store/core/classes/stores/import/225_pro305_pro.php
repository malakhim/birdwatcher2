...
class Stores_Import_225Pro305Pro extends Stores_Import_EditionToEdition
{
	...
	protected function _applayPatches()
	{
		...
		db_import_sql_file(DIR_ADDONS . 'exim_store/database/304_305.sql', 16384, true, true, false, false, false, false);
	}
}
