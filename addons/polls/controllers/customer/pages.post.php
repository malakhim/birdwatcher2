...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($mode == 'poll_submit') {
		...
		if (Registry::get('settings.Image_verification.use_for_polls') == 'Y' && fn_image_verification('poll_' . $prefix . $_REQUEST['page_id'], empty($_REQUEST['verification_answer']) ? '' : $_REQUEST['verification_answer']) == false) {
			return array(CONTROLLER_STATUS_REDIRECT);
		}
