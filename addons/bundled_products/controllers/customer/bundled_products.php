...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($mode == 'calculate') {
		list($total_price, $discount, $discounted_price) = fn_bundled_products_calculate($_REQUEST, $auth);
		
		// Fill the calculation information
		$calculation_info = fn_get_lang_var('bundled_products_calculation_information');
