...
function fn_reward_points_delete_order($order_id)
{
	...
	$status_to = $status_from = '';
	$empty_array = array();
	fn_reward_points_change_order_status($status_to, $status_from, $order_info, $empty_array, $empty_array);
}
...
function fn_reward_points_gather_additional_product_data_post(&$product, &$auth, $params = array())
{
...
function fn_reward_points_apply_option_modifiers_pre(&$fields, $type)
{
