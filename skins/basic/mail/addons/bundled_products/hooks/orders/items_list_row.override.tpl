{if $oi.extra.bundled_products}
	...
	{foreach from=$order_info.items item="sub_oi"}
		{if $sub_oi.extra.parent.bundled_products && $sub_oi.extra.parent.bundled_products==$oi.cart_id}
	...
	<tr>
		...
		{if $oi.extra.parent.bundled_products && $oi.extra.parent.bundled_products == $conf_oi.cart_id}
		<tr>
