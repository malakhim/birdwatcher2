{if $wishlist.products.$key.extra.configuration}
	...
	<div class="product-container clearfix">
		...
		<div class="product-description">
			<a href="{"products.view?product_id=`$product.product_id`"|fn_url}" class="product-title">{$product.product|unescape}</a>&nbsp;<a href="{"wishlist.delete?cart_id=`$key`"|fn_url}" class="icon-delete-big" title="{$lang.remove}"></a>
			...
			<tr {cycle values=",class=\"table-row\""}>				
				...
				<td class="center nowrap">
					{include file="common_templates/price.tpl" value=$product_conf.display_subtotal}&nbsp;&nbsp;</td>
			...
			<tr {cycle values=",class=\"table-row\""}>
				<td colspan="3"><strong>{$lang.product_summary}:</strong></td>
				<td class="center">
