...
{if $smarty.capture.is_conf_prod}
	<p><a rev="bundled_products_{$key}" class="cm-dialog-opener cm-dialog-auto-size">{$lang.bundled_products}</a></p>
	<div class="product-options hidden" id="bundled_products_{$key}" title="{$lang.bundled_products}">
