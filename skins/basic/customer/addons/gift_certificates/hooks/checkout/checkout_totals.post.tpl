...
{foreach from=$cart.use_gift_certificates item="ugc" key="ugc_key"}
	<li class="group-title">
		<span class="checkout-item-title">{$lang.gift_certificate}</span>
	</li>
	<li>
	...
	<span class="checkout-item-value discount-price">-{include file="common_templates/price.tpl" value=$ugc.cost}</span>
	</li>
{/foreach}
{/if}
