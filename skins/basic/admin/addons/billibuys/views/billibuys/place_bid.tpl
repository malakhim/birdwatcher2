...
{if $products}
	<div class="buttons-container buttons-bg">
		<div class="float-left">
			{include file="buttons/save_cancel.tpl" but_text=$lang.btn_place_bid_txt but_name="dispatch[billibuys.m_place_bid]" hide_second_button=true cancel_action="close"}
		</div>
	</div>
{/if}
